...
class App
  ...
  def create_student
    ...
    student = Student.new(age, name, permission_values.includes?(has_permission))
    people.push(student)
  end
  ...
  def list_all_books
    puts books.inspect
    books.each do |book|
      puts "Title: \"#{book.title}\", Author: #{books.author}"
    end
  end
  ...
  def create_rental
    ...
    books.each_with_index do |book, index|
      puts "#{index}) Title: \"#{book.title}\", Author: #{books.author}"
    end
